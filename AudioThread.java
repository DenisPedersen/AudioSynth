...
public class AudioThread extends Thread {
    ...
    AudioThread(Supplier<short[]> bufferSupplier) {
        ...
        catchEternalException(); //skal nok være INTERTAL OBS OBS OBS!!!
        start();
    }
    ...
    public synchronized void run() {
        while (!closed) {
            ...
            catchEternalException(); //INTERNALEXCEPTION OBS OBS OBS!!!!!!!!
        }
    ...
    private void bufferSamples(short[] samples) {
        ...
        bufferIndex %= BUFFER_COUNT;  //sætter bufferindex til 0 når den når 8.
    }

    private void catchEternalException() {
